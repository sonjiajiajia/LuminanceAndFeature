...
def EVCA(args: argparse.Namespace, input_list, device) -> None:
    ...
    for file in input_list:
        ...
        for f in range(0, nframes, steps):
            ...
            # print(f'DTs.shape is {DTs.shape}')
            ...
            # print(f'B_frame.shape is {B_frame.shape}')
            # print(f'SC_frame.shape is {SC_frame.shape}')
            # print(f'TC_frame.shape is {TC_frame.shape}')
            # print(f'TC2_frame.shape is {TC2_frame.shape}')
            if f == 0:
